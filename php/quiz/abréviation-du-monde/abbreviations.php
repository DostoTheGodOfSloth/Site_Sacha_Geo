                ...
                <div class="container-f">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 boxQuiz-1">
                        <div class="titleResult">
                            ...
                            <a href="abbreviations"><img class="btnReload" src="../../../img/icon/reload.png" alt="refresh"/></a>
                            <p id="text" class="timer"></p>
                            <div class="titleResult-1">
                                <p class="titleQuiz">Quels sont ces abréviations ?</p>
                            </div>
                        </div>
                        <form method="post" action="checkAbbreviations" enctype="multipart/form-data" >
                            <div class="flexForm">
                                <?php 
                                    ...
                                    for ($i=0; $i < min(12, count($pays)); $i++) 
                                    {
                                        ...
                                        /**stockage du random */
                                        $pay = $pays[$rnd];
                                        /*Mettre le random dans une variable de session pour pouvoir l'utiliser sur l'autre page*/
                                        $_SESSION["pays"][] = $pay;
                                            echo "
                                                <div class=' cardQuiz'>
                                                    ...
                                                    <div class='form__group field'>
                                                        <input type='input' class='form__field' placeholder='Réponse...' name='abbreviation[]' id='capitals'/>
                ...
                <div class="container-f">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 boxQuiz-1">
                        <div class="titleResult">
                            ...
                            <a href="abbreviations.php"><img class="btnReload" src="../../../img/icon/reload.png" alt="refresh"/></a>
                            <p id="text" class="timer"></p>
                            <div class="titleResult-1">
                                <p class="titleQuiz">Quels sont ces abréviations ?</p>
                            </div>
                        </div>
                        <form method="post" action="checkAbbreviations.php" enctype="multipart/form-data" >
                            <div class="flexForm">
                                <?php 
                                    $pays = $database->getAllPays();
