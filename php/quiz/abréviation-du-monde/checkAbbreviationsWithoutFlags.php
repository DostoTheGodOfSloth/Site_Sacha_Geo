                                ...
                                if(isset($_POST['btnCheck']) && isset($_POST["abbreviation"]) && isset($_SESSION["pays"]))
                                {
                                    ...
                                    echo"<div class='score'>";
                                        ...
                                        echo"<div class='score-2'>";
                                            echo"<a href='abbreviationsWithoutFlags' class='buttonUp-1'>Recommencez</a>";
                                        echo"</div>";
                                    echo"</div>";

                                    if(isset($_SESSION['idUser']))
                                    {
                                        $database->addScore($_SESSION['idUser'], '7', strval($score), $timer);
                                    }
                                }
                            ?>
                        </div>
                            ...
                            <?php
                                ...
                                if(isset($_POST['btnCheck']) && isset($_POST["abbreviation"]) && isset($_SESSION["pays"]))
                                {
                                    ...
                                    echo"<div class='score'>";
                                        ...
                                        echo"</div>";
                                        echo"<div class='score-2'>";
                                            echo"<a href='abbreviationsWithoutFlags.php' class='buttonUp-1'>Recommencez</a>";
                                        echo"</div>";
                                    echo"</div>";
