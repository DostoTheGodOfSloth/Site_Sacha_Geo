                ...
                <div class="container-f">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 boxQuiz-1">
                        <div class="titleResult">
                            ...
                            <a href="capitalsWithoutFlags.php"><img class="btnReload" src="../../../img/icon/reload.png" alt="refresh"/></a>
                            <p id="text" class="timer"></p>
                            <div class="titleResult-1">
                                <p class="titleQuiz">Quels sont ces capitales ?</p>
                            </div>
                        </div>
                        <form method="post" action="checkCapitalsWithoutFlags.php" enctype="multipart/form-data" >
                            <div class="flexForm">
                                <?php 
                                                ...
                                                <div class=' cardQuiz-1'>
                                                 <p class='textCard'>" .$pay['payNom'] . "</p>
                                                    <div class='form__group field'>
                                                        <input type='input' class='form__field' placeholder='Réponse...' name='capitals[]' id='capitals'/>
