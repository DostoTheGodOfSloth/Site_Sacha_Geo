                                ...
                                if(isset($_POST['btnCheck']) && isset($_POST["capitals"]) && isset($_SESSION["pays"]))
                                {
                                    ...
                                    echo"<div class='score'>";
                                        ...
                                        echo"<div class='score-2'>";
                                            echo"<a href='capitalsWithoutFlags.php' class='buttonUp-1'>Recommencez</a>";
                                        echo"</div>";
                                    echo"</div>";

                                    if(isset($_SESSION['idUser']))
                                    {
                                        //Envoie à la db le nom d'utilisateur, id du quiz, le score
                                        $database->addScore($_SESSION['idUser'], '6', strval($score), $timer);
                                    }
                                }
                            ?>
                        </div>
