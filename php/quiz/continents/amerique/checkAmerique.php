                            ...
                            <?php 
                                ...
                                if(isset($_POST['btnCheck']) && isset($_POST["name"]) && isset($_SESSION["pays"]))
                                {
                                    ...
                                    foreach($_POST["name"] as $index => $name)
                                    {
                                        ...
                                        if(removeAccents(trim($name)) == removeAccents(trim($pay["payNom"])))
                                        {
                                            $score++;
                                            echo "
                                                <div class=' cardQuiz'>
                                    ...
                                    echo"<div class='score'>";
                                        ...
                                        echo"<div class='score-2'>";
                                            echo"<a href='amerique.php' class='buttonUp-1'>Recommencez</a>";
                                        echo"</div>";
                                    echo"</div>";

                                    if(isset($_SESSION['idUser']))
                                    {
                                        $database->addScore($_SESSION['idUser'], '10', strval($score), $timer);
                                    }
                                }
                            ?>
                        </div>
