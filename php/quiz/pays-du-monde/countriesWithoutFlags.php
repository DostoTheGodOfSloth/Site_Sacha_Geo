                ...
                <div class="container-f">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 boxQuiz-1">
                        <div class="titleResult">
                            ...
                            <a href="countriesWithoutFlags.php"><img class="btnReload" src="../../../img/icon/reload.png" alt="refresh"/></a>
                            <p id="text" class="timer"></p>
                            <div class="titleResult-1">
                                <p class="titleQuiz">Quels sont ces pays ?</p>
                            </div>
                        </div>
                        <form method="post" action="checkCountriesWithoutFlags.php" enctype="multipart/form-data" >
                            <div class="flexForm">
                                <?php 
