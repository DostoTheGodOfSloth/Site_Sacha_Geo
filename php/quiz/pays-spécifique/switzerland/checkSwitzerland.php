                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 boxQuiz-1">
                        ...
                        <div class="flexForm">
                            <?php 
                                ...
                                if(isset($_POST['btnCheck']) && isset($_POST["cantonName"]) && isset($_SESSION["cantons"]))
                                {
                                    $score = 0;
                                    /*Prend aussi l'index pour récupérer les capitales de l'autre page*/
                                    foreach($_POST["cantonName"] as $index => $nameCanton)
                                    {
                                        $canton = $_SESSION["cantons"][$index];

                                        /*met en miniscule l'insertion et la db pour la correlation */
                                        if(removeAccents(trim($nameCanton)) == removeAccents(trim($canton["canNom"])))
                                        {
                                            $score++;
                                            echo "
                                                <div class=' cardQuiz-cantons'>
                                                    <p class='textCard'>" .$canton['canChef'] . "</p>
                                                    <img src='../../../../img/cantons/" .$canton['idCanton'] .".png' class='imgCapital-quiz-cantons' alt'Drapeau d'un pays'>
                                                    <div class='form__group field'>
                                                        <input type='input' class='form__field right' value='".$canton['canNom']."' disabled/>
                                        ...
                                        else
                                        {
                                            echo "
                                                <div class=' cardQuiz-cantons'>
                                                    ...
                                                    <img src='../../../../img/cantons/" .$canton['idCanton'] .".png' class='imgCapital-quiz-cantons' alt'Drapeau d'un pays'>
                                                    <div class='form__group field'>
                                                        <input type='input' class='form__field wrong' value='".$canton['canNom']."' disabled/>
                                                        <label for='name' class='form__label-1'>Nom</label>
                                                    </div>
                                                </div>
                                            ";
                                    ...
                                    echo"<div class='score'>";
                                        ...
                                        echo"<div class='score-2'>";
                                            echo"<a href='switzerland.php' class='buttonUp-1'>Recommencez</a>";
                                        echo"</div>";
                                    echo"</div>";

                                    if(isset($_SESSION['idUser']))
                                    {
                                        $database->addScore($_SESSION['idUser'], '9', strval($score), $timer);
                                    }
                                }
                            ?>
                        </div>
