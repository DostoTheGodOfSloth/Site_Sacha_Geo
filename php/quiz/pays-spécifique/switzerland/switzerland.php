                ...
                <div class="container-f">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 boxQuiz-1">
                        <div class="titleResult">
                            ...
                            <a href="switzerland.php"><img class="btnReload" src="../../../../img/icon/reload.png" alt="refresh"/></a>
                            <p id="text" class="timer"></p>
                            <div class="titleResult-1">
                                <p class="titleQuiz">Quels sont ces cantons ?</p>
                            </div>
                        </div>
                        <form method="post" action="checkSwitzerland.php" enctype="multipart/form-data" >
                            <div class="flexForm">
                                <?php
                                    $cantons = $database->getAllCantons();

                                    /*reset la variable $_SESSION["pays"]*/
                                    unset($_SESSION["cantons"]);

                                    foreach ($cantons as $canton)
                                    {
                                        /*random sur la bd entière*/
                                        $rnd = rand(0, count($cantons) - 1);
                                        /**stockage du random */
                                        $canton = $cantons[$rnd];
                                            ...
                                            echo "
                                                <div class=' cardQuiz-cantons'>
                                                    ...
                                                    <div class='form__group field'>
                                                        <input type='input' class='form__field' placeholder='Réponse...' name='cantonName[]' id='name'/>
                                                        <label for='name' class='form__label'>Nom</label>
                                                    </div>
                                                </div>
                                            ";
                                        /* Efface et remplace une portion du tableau $pays */
                                        array_splice($cantons, $rnd, 1);
                                    }
